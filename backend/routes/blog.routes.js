...
router.route('/')
    ...
    .post(
        ...
        ]), protect, handleCreateBlog) //create a new blog

router.route('/:id')
    .get(handleGetBlog) //get a perticular blog of user
    .patch(protect, handleUpdateBlog) //if a user want to edit his/her blog
    .delete(protect, handleDeleteBlog) //if a user want to delete its blog
